...
class WorldLanguage extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'pickup Delivery Price': 'pickup Delivery Price',
        },
        'ru_RU': {
          'Delivery Name': 'авах нэр',
          'pickup Name': 'авах хаяг',
          'delivery Address': 'хүргэлтийн хаяг',
          'pickup Delivery Price': 'авах үнэ',
          'Payments': 'Төлбөр',
          'Message': 'Захиа',
          'issue': 'асуудал',
          'Support': 'Дэмжлэг',
          ...
          'Phone No': 'Утасны дугаар',
          'Status': 'Статус',
          'Vehicle Details': 'Дэлгэрэнгүй',
          ...
          'approved': 'Зөвшөөрсөн',
          'total': 'Нийт',
          'oldCustomer': 'Хуучин үйлчлүүлэгч',
          'drivers': 'жолооч нар',
          'submit': "Илгээх",
